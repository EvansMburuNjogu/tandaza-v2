...
export const callingCodeOptions: CallingCodeOption[] = [
  ...
  { iso: "VG", country: "British Virgin Islands", code: "+1" },
  { iso: "BN", country: "Brunei", code: "+673" },
  ...
  { iso: "KY", country: "Cayman Islands", code: "+1" },
  ...
  { iso: "CC", country: "Cocos Islands", code: "+61" },
  ...
  { iso: "CD", country: "Democratic Republic of the Congo", code: "+243" },
  { iso: "DK", country: "Denmark", code: "+45" },
  { iso: "DJ", country: "Djibouti", code: "+253" },
  { iso: "DM", country: "Dominica", code: "+1" },
  { iso: "DO", country: "Dominican Republic", code: "+1" },
  ...
  { iso: "SZ", country: "Eswatini", code: "+268" },
  { iso: "ET", country: "Ethiopia", code: "+251" },
  { iso: "FK", country: "Falkland Islands", code: "+500" },
  ...
  { iso: "GD", country: "Grenada", code: "+1" },
  { iso: "GP", country: "Guadeloupe", code: "+590" },
  { iso: "GU", country: "Guam", code: "+1" },
  ...
  { iso: "CI", country: "Ivory Coast", code: "+225" },
  { iso: "JM", country: "Jamaica", code: "+1" },
  ...
  { iso: "FM", country: "Micronesia", code: "+691" },
  { iso: "MD", country: "Moldova", code: "+373" },
  { iso: "MC", country: "Monaco", code: "+377" },
  { iso: "MN", country: "Mongolia", code: "+976" },
  { iso: "ME", country: "Montenegro", code: "+382" },
  { iso: "MS", country: "Montserrat", code: "+1" },
  ...
  { iso: "KP", country: "North Korea", code: "+850" },
  { iso: "MK", country: "North Macedonia", code: "+389" },
  { iso: "MP", country: "Northern Mariana Islands", code: "+1" },
  { iso: "NO", country: "Norway", code: "+47" },
  { iso: "OM", country: "Oman", code: "+968" },
  { iso: "PK", country: "Pakistan", code: "+92" },
  { iso: "PW", country: "Palau", code: "+680" },
  { iso: "PS", country: "Palestine", code: "+970" },
  ...
  { iso: "CG", country: "Republic of the Congo", code: "+242" },
  ...
  { iso: "KN", country: "Saint Kitts and Nevis", code: "+1" },
  { iso: "LC", country: "Saint Lucia", code: "+1" },
  { iso: "MF", country: "Saint Martin", code: "+590" },
  { iso: "PM", country: "Saint Pierre and Miquelon", code: "+508" },
  { iso: "VC", country: "Saint Vincent and the Grenadines", code: "+1" },
  ...
  { iso: "SX", country: "Sint Maarten", code: "+1" },
  ...
  { iso: "SY", country: "Syria", code: "+963" },
  { iso: "TW", country: "Taiwan", code: "+886" },
  { iso: "TJ", country: "Tajikistan", code: "+992" },
  { iso: "TZ", country: "Tanzania", code: "+255" },
  ...
  { iso: "TT", country: "Trinidad and Tobago", code: "+1" },
  { iso: "TN", country: "Tunisia", code: "+216" },
  { iso: "TR", country: "Turkey", code: "+90" },
  { iso: "TM", country: "Turkmenistan", code: "+993" },
  { iso: "TC", country: "Turks and Caicos Islands", code: "+1" },
  { iso: "TV", country: "Tuvalu", code: "+688" },
  { iso: "VI", country: "U.S. Virgin Islands", code: "+1" },
  ...
  { iso: "VA", country: "Vatican City", code: "+39" },
