...
export function OrganizerShell({ 
  ...
  const activeNavItems = navItems || organizerNavItems

  useEffect(() => {
    const stored = window.localStorage.getItem("tandaza-organizer-sidebar-collapsed")
  ...
  function toggleCollapsed() {
    setCollapsed((value) => {
      const next = !value
      window.localStorage.setItem("tandaza-organizer-sidebar-collapsed", String(next))
      return next
    })
  }
