  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <AdminSidebar
        ...
        navItems={navItems}
      />
      <div className={collapsed ? "relative z-10 lg:pl-[72px] transition-[padding] duration-300 ease-in-out" : "relative z-10 lg:pl-[260px] transition-[padding] duration-300 ease-in-out"}>
        <div className="flex h-screen flex-col">
          ...
          />
          <main className="flex-1 overflow-y-auto px-4 py-4 pb-32 sm:px-6 sm:py-5 sm:pb-28 lg:px-8 lg:py-7 lg:pb-8">
