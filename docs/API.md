...
| Method | Path | Purpose |
| --- | --- | --- |
| `GET` | `/api/v1/organizer/profile` | Load organizer profile, company details, and notification preferences |
| `PATCH` | `/api/v1/organizer/profile` | Update organizer profile and notification preferences |
