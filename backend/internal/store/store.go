...
type Store interface {
	...
	ListLiveStreamChatMessages(ctx context.Context, expoID string, exhibitorID string, actor domain.User) ([]domain.LiveStreamChatMessageRecord, error)
	CreateLiveStreamChatMessage(ctx context.Context, expoID string, exhibitorID string, input domain.LiveStreamChatMessageInput, actor domain.User) (domain.LiveStreamChatMessageRecord, error)
	ListTourProgress(ctx context.Context, actor domain.User) ([]domain.UserTourProgressRecord, error)
	SaveTourProgress(ctx context.Context, actor domain.User, input domain.UserTourProgressInput) (domain.UserTourProgressRecord, error)
